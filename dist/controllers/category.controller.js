...
exports.getAllCategories = exports.getCategoryByName = exports.createCategory = void 0;
...
var createCategory = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var name_1, categoryExists, category, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, category_model_1.default.findOne({ name: name_1 })];
            case 1:
...
var getCategoryByName = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var name_2, filter, category, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                return [4 /*yield*/, category_model_1.default.find(filter)];
            case 1:
                category = _a.sent();
                res.status(200).json({
                    success: true,
